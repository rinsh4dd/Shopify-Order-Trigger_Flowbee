...
export async function action({ request }) {
  ...
  try {
    ...
    console.log("[WEBHOOK] Checkout signature validation failed, falling back to manual parsing:", error.message);
    ...
    topic = clonedRequest.headers.get("x-shopify-topic") || "checkouts/create";
  ...
  try {
    ...
    console.error("[WEBHOOK] Error processing checkout webhook:", err.message);
  }
